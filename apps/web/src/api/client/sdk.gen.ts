...
import type { SelfProfileData, SelfProfileResponse, UserProfileData, UserProfileResponse, ListenHistData, ListenHistResponse } from './types.gen';
...
export const selfProfile = <ThrowOnError extends boolean = false>(options?: Options<SelfProfileData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<SelfProfileResponse, unknown, ThrowOnError>({
